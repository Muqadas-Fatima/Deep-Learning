...
using **NumPy first**, followed by **PyTorch**.
...
* Created and loaded a synthetic regression dataset.
* Implemented the forward pass of a single neuron from scratch using NumPy.
* Generated predictions using manually initialized weights and bias.
* Computed prediction error using Mean Squared Error (MSE).

**Key Takeaway:** Built a solid understanding of how a single neuron computes predictions using the linear equation **(y = XW + b)**.
